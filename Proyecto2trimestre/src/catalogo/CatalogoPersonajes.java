...
public class CatalogoPersonajes {
	...
	public static Personajes crearGeralt() {
	    Guerrero geralt = new Guerrero("Geralt de Rivia", 400, 100, 85, 30, 0, 20, 0.20);
	...
	public static Personajes crearYennefer() {
	    Mago yennefer = new Mago("Yennefer de Vengerberg", 200, 300, 30, 10, 100, 1.5);
	...
	public static Personajes crearCiri() {
	    Sacerdote ciri = new Sacerdote("Ciri", 300, 200, 70, 20, 50, 20);
	...
	public static Personajes crearImlerith() {
	    Guerrero imlerith = new Guerrero("Imlerith", 500, 50, 90, 35, 0, 30, 0.15);
	...
	public static Personajes crearCaranthir() {
	    Mago caranthir = new Mago("Caranthir", 250, 280, 25, 10, 90, 1.3);
	...
	public static Personajes crearEredin() {
	    Sacerdote eredin = new Sacerdote("Eredin", 400, 200, 60, 25, 60, 15);
