...
/**
 * La clase CatalogoPersonajes actúa como una Factoría (Factory pattern) para 
 * instanciar a los personajes del juego.
 * <p>
 * Contiene métodos estáticos que devuelven a los distintos héroes y villanos 
 * preconfigurados con sus estadísticas base, identificadores, armas disponibles y hechizos.
 * </p>
 */
public class CatalogoPersonajes {

    // ================= EQUIPO BUENO (Aliados) =================

    /**
     * Crea e inicializa a Geralt de Rivia, un personaje de la clase {@link Guerrero}.
     * * @return Una instancia preconfigurada de Geralt con sus armas y hechizos.
     */
    ...
    /**
     * Crea e inicializa a Yennefer de Vengerberg, un personaje de la clase {@link Mago}.
     * * @return Una instancia preconfigurada de Yennefer con sus armas y hechizos.
     */
    ...
    /**
     * Crea e inicializa a Ciri, un personaje de la clase {@link Sacerdote} (Apoyo).
     * * @return Una instancia preconfigurada de Ciri con sus armas y hechizos.
     */
    ...
    // ================= EQUIPO MALO (La Cacería Salvaje) =================

    /**
     * Crea e inicializa a Imlerith, un jefe de la clase {@link Guerrero}.
     * * @return Una instancia preconfigurada de Imlerith con sus armas y hechizos.
     */
    ...
    /**
     * Crea e inicializa a Caranthir, un jefe de la clase {@link Mago}.
     * * @return Una instancia preconfigurada de Caranthir con sus armas y hechizos.
     */
    ...
    /**
     * Crea e inicializa a Eredin, el jefe final de la clase {@link Sacerdote} (Apoyo oscuro).
     * * @return Una instancia preconfigurada de Eredin con sus armas y hechizos.
     */
