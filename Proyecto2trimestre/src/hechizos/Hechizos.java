...
public abstract class Hechizos {
    ...
    // ALIADO_UNICO:  hechizos de curación (Poción de Golondrina, Sacrificio Oscuro...)
    ...
    public int getPotenciaBase() { return potenciaBase; }
    public int getCooldownMaximo() { return cooldownMaximo; }
    public TipoObjetivo getTipoObjetivo() { return objetivo; }
